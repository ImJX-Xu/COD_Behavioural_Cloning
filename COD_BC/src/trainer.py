    ...
    for epoch in range(1, effective_epochs + 1):
        ...
        for batch_idx, batch in enumerate(train_loader, start=1):
            ...
            if USE_KEYBOARD and use_key_loss:
                ...
                loss = 0.35 * (loss_mouse_x + loss_mouse_y) + 0.3 * mouse_btn_loss + 0.3 * keys_loss
            else:
                loss = 0.5 * (loss_mouse_x + loss_mouse_y) + 0.5 * mouse_btn_loss
            ...
            # 梯度累积：每 accum_steps 个 batch 更新一次
